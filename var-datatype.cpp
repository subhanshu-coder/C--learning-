...
int main() {
    ...
    return 0;  
     It is a convention to return -1 or any non-zero value to indicate an error condition. In this case, returning 0 indicates that the program has executed successfully without any errors.
    // 
}
